...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: HomeCatalogoWidget.routePath,
          builder: (context, params) => HomeCatalogoWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: EnvioWidget.routeName,
          path: EnvioWidget.routePath,
          builder: (context, params) => EnvioWidget(),
        ),
        FFRoute(
