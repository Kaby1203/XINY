...
import 'envio_model.dart';
export 'envio_model.dart';

class EnvioWidget extends StatefulWidget {
  const EnvioWidget({super.key});

  static String routeName = 'Envio';
  static String routePath = '/envio';

  @override
  State<EnvioWidget> createState() => _EnvioWidgetState();
}

class _EnvioWidgetState extends State<EnvioWidget> {
  late EnvioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EnvioModel());
    ...
    _model.txtCiudadTextController ??= TextEditingController();
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                TextFormField(
                                  controller: _model.txtCiudadTextController,
                                ...
                                TextFormField(
                                  ...
                                  focusNode: _model.txtCodigoPostalFocusNode,
                                  autofocus: false,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ClipRRect(
                                            ...
                                            child: Image.network(
                                              'https://images.unsplash.com/photo-1703531293255-0b16d10fe09f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzM3ODUwMDR8&ixlib=rb-4.1.0&q=80&w=1080',
                                              width: 52.0,
                                              height: 52.0,
                                              fit: BoxFit.cover,
                                            ),
                                        ...
                                        children: [
                                          ClipRRect(
                                            borderRadius:
                                                BorderRadius.circular(8.0),
                                            child: Image.network(
                                              'https://images.unsplash.com/photo-1584969125362-ce32007eecc3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NzM3ODUwMDR8&ixlib=rb-4.1.0&q=80&w=1080',
                                              width: 52.0,
                                              height: 52.0,
                                              fit: BoxFit.cover,
                                            ),
                          ...
                          children: [
                            Theme(
                              ...
                              child: Checkbox(
                                ...
                                side: (Color(0xFFBDBDBD) != null)
                                    ? BorderSide(
                                        width: 2,
                                        color: Color(0xFFBDBDBD),
                                      )
                                    : null,
                                activeColor: Color(0xFFFFB6C1),
                            ...
                            onPressed: () async {
                              await PedidosRecord.collection
                                  ...
                                  .set(createPedidosRecordData(
                                    ...
                                    fechaPedido: getCurrentTimestamp,
                                    productos: 'Compra desde app',
                                  ));
                            },
