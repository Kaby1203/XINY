...
class LoginRegistroWidget extends StatefulWidget {
  ...
  static String routeName = 'Login_registro';
  static String routePath = '/loginRegistro';
...
class _LoginRegistroWidgetState extends State<LoginRegistroWidget>
  ...
  void initState() {
    ...
    _model.crearContraTextController ??= TextEditingController();
    _model.crearContraFocusNode ??= FocusNode();
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        key: scaffoldKey,
        backgroundColor: Color(0xFFF8F4F6),
        body: SafeArea(
          top: true,
          child: Stack(
            children: [
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Container(
                                              ...
                                              child: TextFormField(
                                                controller: _model
                                                    .crearContraTextController,
                                                focusNode:
                                                    _model.crearContraFocusNode,
                                                autofocus: true,
                                                autofillHints: [
                                                  AutofillHints.password
                                                ],
                                                obscureText: !_model
                                                    .crearContraVisibility,
                                                decoration: InputDecoration(
                                                ...
                                                validator: _model
                                                    .crearContraTextControllerValidator
                                                    .asValidator(context),
                                              ),
                                            ),
                                          ),
